...
<body>
   <form action="BestellPos_insert.jsp" method="post">
     <table border="0">
       <tr>
        <td>TrackingID:</td>
       ...
       <tr>
        <td>PosNr:</td>
        <td><input type="text" name="PosNr" /></td>
       </tr>
       <tr>
        <td>Menge:</td>
       ...
       <tr>
        ...
        <tr>
        <td>bestelleinheit:</td>
        <td>
        <select name="bestelleinheit">
  <option value="Stk">Stk</option>
  <option value="Karton">Karton</option>
  <option value="Pslette">Pslette</option>
       ...
       %>
        <%  
      String query2 = "SELECT produktNr FROM Produkt";
       ...
       %>
        <%  
      String query22 = "SELECT Bestellungnummer FROM Bestellung";
